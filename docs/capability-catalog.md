...
| Data-defined local semantic entities | Implemented foundation | `aws` | Versioned operation templates compile locally with Path bindings. Quantity/event observation and selected-relation correction seeds exist; correction provenance/version history and formal contract schemas remain incomplete. |
