# 1var in Fewer Than 200 Words

See the [medium overview](onevar-medium.md) or [canonical reading order](../README.md#reading-order) for detail.

1var is a local-first platform that lets people use voice or messages to create, query, connect, execute, communicate, navigate, and govern digital things.
...
ContextDB makes spoken data usable immediately. Permitted changes publish asynchronously as governed server entities so authorized people and devices can find and reuse them. Validated Paths and compositional subpatterns make future interactions faster, cheaper, and more dependable.
