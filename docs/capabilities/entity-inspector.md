...
- three simultaneous neighbor-attraction passes compact only exact connected components after a scene change, progressive append, drag, pan, or reveal; the spatially hashed collision pass then restores separation, the browser animates to the one target for 320 milliseconds, and all layout work stops;
...
Release `c644b8ed04de2081947710ad6cf3e5fbd99c6feb` passed the complete repository gate and browser suite in [CI workflow 33922870364](https://github.com/jaustinhughesgit/onevar-platform/actions/runs/33922870364). [Development deployment 33923532678](https://github.com/jaustinhughesgit/onevar-platform/actions/runs/33923532678) published that exact immutable release through CloudFront without resetting user data. Its regression proof covers deterministic edge-order-independent component compaction, shorter collective exact-edge length, immobile dragged anchors with moving neighbors, unaffected disconnected points, and collision padding after attraction.

See [decision 0130](../../decisions/0130-inspector-renders-local-state-before-progressive-authorized-discovery.md), [decision 0132](../../decisions/0132-inspector-keeps-a-wide-focus-plateau-and-animates-settling.md), [decision 0134](../../decisions/0134-inspector-point-moats-distinguish-edge-incidence.md), [decision 0135](../../decisions/0135-inspector-v2-compiles-bounded-semantic-scenes.md), [decision 0136](../../decisions/0136-inspector-colors-follow-entity-ray-placement.md), and [decision 0137](../../decisions/0137-inspector-compacts-exact-connected-components.md).
