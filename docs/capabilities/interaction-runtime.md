...
- Typed Path promotion resolves an unambiguous nested descriptor/noun-head overlap into separate linear slots before testing and persistence. If removing typed nested spans does not leave one contiguous noun-bearing head, promotion fails rather than guessing or dropping a binding.
