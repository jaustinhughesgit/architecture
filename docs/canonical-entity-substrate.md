...
4. **Authorization is action-specific.** Discovering a Word, embedding, address, or entity candidate grants no read, aggregate, use, execute, edit, delete, delegate, publish, or govern authority.
