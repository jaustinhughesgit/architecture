...
- Implemented and development-proven in Phase 4G: exact installations, licenses, concurrency-safe usage receipts, zero-use refunds, publisher attribution, collaboration grants, licensed forks, and discoverable-passkey same-account release-delta synchronization independently of user data and protected assets.
