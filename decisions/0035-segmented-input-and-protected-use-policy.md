...
Ask opens Message and may queue only the fixed, non-protected approval notice. Don't ask keeps the answer masked without that notice. A microphone press interrupts the notice under the same capture-preemption rule.
