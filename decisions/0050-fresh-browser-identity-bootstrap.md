...
The flag grants no access to an existing account and cannot weaken another route's authorization. It creates a new anonymous identity by explicit navigation to the new-user surface. Existing identity cookies are expired rather than copied, logged, or returned in response JSON.
