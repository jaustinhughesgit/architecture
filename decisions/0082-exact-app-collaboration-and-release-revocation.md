...
**Status:** Accepted; clean-room contract/runtime implemented and locally proven. Authenticated cross-user grant delivery and same-account menu synchronization remain partial.
