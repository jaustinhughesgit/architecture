...
Development release `866e771206283d66471d8cfda3ee8fbb64f1a43e` passed full verification and all 16 graph browser tests in [workflow 34667064470](https://github.com/jaustinhughesgit/onevar-platform/actions/runs/34667064470). The separately opted-in real-adviser description canary passed in 14.6 seconds: a fresh account learned a rundown opening, reused it for another entity with selected fields, and reused it after reload without another proposal. Shared development accounts/graphs were not reset. The first local browser run exposed a broad app-opening alias conflict plus two stale learning fixtures; library-driven dispatch and updated uncovered-grammar fixtures repaired those failures before the successful 20-test rerun and release.
