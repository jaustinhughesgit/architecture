...
6. [Clean-room platform roadmap](docs/clean-room-roadmap.md)
7. [JPL, Shorthand, and ArrayLogic](docs/execution-representations.md)
8. [Intent routing and entity evolution](docs/intent-routing-and-entity-evolution.md)
9. [Cross-layer flows](docs/cross-layer-flows.md)
10. [Headless acceptance testing](docs/headless-acceptance-testing.md)
11. [Security and trust](docs/security-and-trust.md)
12. [Capability catalog](docs/capability-catalog.md)
13. [Canonical entity substrate](docs/canonical-entity-substrate.md)
14. [Canonical indexing and Context compilation](docs/canonical-indexing-and-context-compilation.md)
15. [Entity middleware, composition, and governance](docs/entity-middleware-composition-and-governance.md)
16. [Execution envelopes and governed interaction](docs/execution-envelopes-and-governed-interaction.md)
17. [Canonical-substrate compatibility inventory](docs/canonical-substrate-compatibility-inventory.md)
18. [Canonical-substrate migration](docs/canonical-substrate-migration.md)
19. Capability specifications:
   ...
   - [Entity Inspector](docs/capabilities/entity-inspector.md)
